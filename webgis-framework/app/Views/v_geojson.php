...
<script>
    ...
    const map = L.map('map', {
        center: [-7.603798397969033, 111.25019913884863],
        zoom: 11,
        layers: [peta2]
    });
...
function generatePopupContent(data) {
    ...
    <div style="font-family: Arial, sans-serif; font-size: 13px; line-height: 1.4; width: 250px;">
        <div style="display: flex; align-items: center; margin-bottom: 8px;">
            ...
            <h4 style="margin: 0; font-size: 15px;">Informasi Sengketa Tanah</h4>
        </div>
...
const markersData = [
    ...
    },
    {
        ...
        desa: "<br>A. Klodran,<br>B. Malangjiwan,<br>C. Selokaton",
        kecamatan: "<br>A. Colomadu,<br>B. Colomadu,<br>C. Gondangrejo",
        hm: "<br>A. HM 826, 827, 828, 829, 131, 525, 1979,<br>B. HM 2797, 2765, 1917,<br>C. HM 269 ",
    ...
    },
    {
        ...
        desa: "<br>A. Popongan,<br>B. Tegalgede",
        kecamatan: "<br>A. Karanganyar,<br>B. Karanganyar",
        hm: "<br>A. HM 2550,<br>B. HM 3649",
        posisiBpn: "Tergugat III",
        tipologi: "Kepemilkan dan Penguasaan Hak atas tanah (Hutang Pihutang)"
    },
];
...
legendStatus.onAdd = function (map) {
    const div = L.DomUtil.create('div', 'info legend');
    div.innerHTML = `
        <div style="background: white; padding: 10px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.3); font-family: Arial, sans-serif; font-size: 12px; width: 160px;">
            ...
            <div id="legendStatusContent" style="display: none;">
                <img src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-red.png" width="18" height="28"> PROSES<br>
                <img src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-yellow.png" width="18" height="28"> DICABUT<br>
                <img src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-blue.png" width="18" height="28"> DAMAI<br>
                <img src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-green.png" width="18" height="28"> PUTUSAN<br>
            </div>
        </div>
    `;
    ...
    setTimeout(() => {
        ...
        toggleBtn.addEventListener('click', () => {
            if (legendContent.style.display === "none") {
                ...
                toggleBtn.innerHTML = "Sembunyikan Status ⬆️";
            } else {
                legendContent.style.display = "none";
                toggleBtn.innerHTML = "Tampilkan Status ⬇️";
            }
        });
    }, 500);
...
setTimeout(() => {
    ...
    resetButton.addEventListener('click', function() {
        map.setView([-7.603798397969033, 111.25019913884863], 11); // Center + zoom 11
    });
